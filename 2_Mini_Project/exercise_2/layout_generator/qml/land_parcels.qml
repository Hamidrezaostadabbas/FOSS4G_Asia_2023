...
<qgis simplifyAlgorithm="0" styleCategories="AllStyleCategories" version="3.22.4-Białowieża" simplifyLocal="1" readOnly="0" maxScale="0" symbologyReferenceScale="-1" minScale="100000000" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1">
  <flags>
  ...
  <temporal startField="" endField="" endExpression="" fixedDuration="0" enabled="0" limitMode="0" startExpression="" durationUnit="min" mode="0" accumulate="0" durationField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory opacity="1" spacingUnit="MM" height="15" width="15" sizeType="MM" maxScaleDenominator="1e+08" spacingUnitScale="3x:0,0,0,0,0,0" scaleDependency="Area" diagramOrientation="Up" lineSizeScale="3x:0,0,0,0,0,0" barWidth="5" showAxis="1" rotationOffset="270" backgroundColor="#ffffff" enabled="0" penAlpha="255" penWidth="0" minimumSize="0" labelPlacementMethod="XHeight" minScaleDenominator="0" lineSizeType="MM" penColor="#000000" spacing="5" backgroundAlpha="255" direction="0" sizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0">
  ...
  <DiagramLayerSettings showAll="1" dist="0" linePlacementFlags="18" placement="1" priority="0" obstacle="0" zIndex="0">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="admin_leve" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="6" field="admin_leve"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="osm_way_id" unique_strength="0" notnull_strength="0"/>
    ...
    <constraint constraints="0" exp_strength="0" field="aeroway" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="amenity" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="admin_leve" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="barrier" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="boundary" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="building" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="craft" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="geological" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="historic" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="land_area" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="landuse" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="leisure" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="man_made" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="military" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="natural" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="office" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="place" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="shop" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="sport" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="tourism" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="other_tags" unique_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="admin_leve" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column name="osm_way_id" type="field" hidden="0" width="-1"/>
      <column name="name" type="field" hidden="0" width="-1"/>
      <column name="type" type="field" hidden="0" width="-1"/>
      <column name="aeroway" type="field" hidden="0" width="-1"/>
      <column name="amenity" type="field" hidden="0" width="-1"/>
      <column name="admin_leve" type="field" hidden="0" width="-1"/>
      <column name="barrier" type="field" hidden="0" width="-1"/>
      <column name="boundary" type="field" hidden="0" width="-1"/>
      <column name="building" type="field" hidden="0" width="-1"/>
      <column name="craft" type="field" hidden="0" width="-1"/>
      <column name="geological" type="field" hidden="0" width="-1"/>
      <column name="historic" type="field" hidden="0" width="-1"/>
      <column name="land_area" type="field" hidden="0" width="-1"/>
      ...
      <column name="military" type="field" hidden="0" width="-1"/>
      <column name="natural" type="field" hidden="0" width="-1"/>
      <column name="office" type="field" hidden="0" width="-1"/>
      <column name="place" type="field" hidden="0" width="-1"/>
      <column name="shop" type="field" hidden="0" width="-1"/>
      <column name="sport" type="field" hidden="0" width="-1"/>
      <column name="tourism" type="field" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="Bilder1" editable="1"/>
    <field name="Bilder2" editable="1"/>
    <field name="Bilder3" editable="1"/>
    <field name="Bilder4" editable="1"/>
    <field name="Eigenturm" editable="1"/>
    <field name="Flur" editable="1"/>
    <field name="FlurstNenn" editable="1"/>
    <field name="FlurstZäh" editable="1"/>
    <field name="Gemarkung" editable="1"/>
    ...
    <field name="erschlissu" editable="1"/>
    <field name="flur_nr" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="Eigenturm" labelOnTop="0"/>
    <field name="Flur" labelOnTop="0"/>
    <field name="FlurstNenn" labelOnTop="0"/>
    <field name="FlurstZäh" labelOnTop="0"/>
    <field name="Gemarkung" labelOnTop="0"/>
    <field name="Kommentar" labelOnTop="0"/>
    <field name="admin_leve" labelOnTop="0"/>
    ...
    <field name="erschlissu" labelOnTop="0"/>
    <field name="flur_nr" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="Eigenturm" reuseLastValue="0"/>
    <field name="Flur" reuseLastValue="0"/>
    <field name="FlurstNenn" reuseLastValue="0"/>
    <field name="FlurstZäh" reuseLastValue="0"/>
    <field name="Gemarkung" reuseLastValue="0"/>
    ...
    <field name="erschlissu" reuseLastValue="0"/>
    <field name="flur_nr" reuseLastValue="0"/>
